...
export default function Home() {
    const Navbar: React.FC<NavbarProps> = ({
        ...
        return (
            <motion.nav
                className={`absolute top-0 left-0 w-full z-20 p-6 text-black ${inter.className}`}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between items-center gap-6 h-16">
                        ...
                        <motion.input
                            ...
                            autoComplete="off"
                            placeholder="Search..."
                            className={`w-60 px-6 h-10  rounded-full text-base border border-black text-gray-700 placeholder-gray-40 outline-none ${inter.className}`}
                        />
        ...
        <>
            ...
            <main className="overflow-hidden mt-10">
                ...
                <main className="h-screen mt-20">
                    <p className="text-2xl text-center">Place to go based on your search</p>
                </main>
                <Footer />
            </main>
        </>
