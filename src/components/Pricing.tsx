...
const PricingList = [
  {
    ...
    features: [
      { name: "Unlimited influencer relationships", available: true },
      { name: "Compiled influed post Management", available: true },
      { name: "Advanced search engine", available: false },
      { name: "Access to 7M+ Influencers", available: false },
      { name: "Upload video in up to 4k", available: false },
      { name: "Unlimited Projects", available: false },
      { name: "Actionable Influencer insight", available: false },
      { name: "Influencer Revenue Track", available: false },
    ],
  ...
  },
  {
    ...
    per: { month: "/ Month", year: "/ Year" },
    tagline: "Perfect for creators and freelancers needing more control.",
    features: [
      { name: "Unlimited influencer relationships", available: true },
      { name: "Dedicated Person", available: true },
      { name: "Advanced search engine", available: true },
      { name: "Access to 7M+ Influencers", available: true },
      { name: "Upload video in up to 4k", available: true },
  ...
  },
  {
    ...
    per: { month: "/ Month", year: "/ Year" },
    tagline: "Best for businesses needing full features and support.",
    features: [
      { name: "Unlimited influencer relationships", available: true },
      { name: "Dedicated Person", available: true },
      { name: "Advanced search engine", available: true },
      ...
      { name: "Upload video in up to 4k", available: true },
      { name: "Unlimited Projects", available: true },
      { name: "Actionable Influencer insight", available: true },
      { name: "Influencer Revenue Track", available: true },
    ],
    buttonText: "Get Started Now",
    featured: false,
  },
...
const Pricing = () => {
  ...
  return (
    <motion.section
      ...
      className="container max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8"
    >
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl">
          {PricingList.map((pricing, index) => (
            <motion.div
              ...
              whileHover="hover"
              className={`flex flex-col h-full shadow-lg hover:shadow-xl ${
                pricing.featured
            ...
            >
              ...
              <div className="flex items-baseline gap-1 mb-6">
                ...
                {isYearly && pricing.tier !== "Free" && (
                  <span className="ml-2 px-2 py-0.5 text-xs rounded bg-green-50 text-green-600 font-medium">
                    Save {pricing.tier === "Pro" ? "$10" : "$20"}/year
                  </span>
                )}
              </div>
