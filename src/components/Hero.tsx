      ...
      >
        ...
        >
          ...
          >
            ...
            <div className="">
              <motion.p
                className="text-base sm:text-lg mb-6 sm:mb-8 opacity-90 px-4"
                variants={itemVariants}
              >
              ...
              {/* Floating Arrow */}
              <motion.div
                className="absolute left-20 sm:left-32 xl:left-56 bottom-32 sm:bottom-40 xl:bottom-48 max-w-32 xl:max-w-44 hidden xl:block"
        ...
        {/* Search Bar */}
        <motion.div
          className="relative bg-white rounded-full shadow-sm p-2 top-4 sm:top-6 md:top-8 md:w-full xl:w-full max-w-sm sm:max-w-2xs md:max-w-2xl mx-auto px-4"
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1">
              <input
                ...
                className={`w-full px-4 sm:px-6 py-2 sm:py-3 rounded-full text-sm sm:text-base text-gray-700 placeholder-gray-400 outline-none ${inter.className}`}
              />
            </div>
            <motion.button
              ...
              whileHover="hover"
              whileTap="tap"
              className={`bg-pink-600 text-white px-3 sm:px-5 py-2 sm:py-2.5 rounded-full font-medium cursor-pointer flex items-center gap-2 text-sm sm:text-base ${inter.className}`}
