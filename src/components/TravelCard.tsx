...
const travelData = [
  {
    ...
    description:
      "Curug Lima Semaya is a beautiful multi-tiered waterfall nestled in Central Java's lush tropical forest. With relatively easy access and a peaceful natural atmosphere, it’s perfect for those seeking tranquility and scenic views. Surrounded by dense greenery and fresh air, it offers a refreshing escape from the city.",
  },
  {
    id: 2,
    ...
    description:
      "Curug Kalidatar offers a stunning waterfall landscape with crystal-clear water and natural rock formations. It’s an ideal spot for weekend relaxation, family picnics, or playing in the water. The unspoiled surroundings make this destination a hidden gem for nature lovers.",
  },
  {
    id: 3,
    ...
    description:
      "Kedung Jayub is a natural spring pool formed by a flowing river through rocky terrain. It’s a great place for swimming, water play, and soaking in the refreshing vibes of nature. Loved by local travelers, it’s a peaceful spot for unwinding and reconnecting with the outdoors.",
  },
  {
    id: 4,
    title: "Curug Nangga",
    ...
    description:
      "Famous for its unique seven-tiered waterfall, Curug Nangga offers a breathtaking view and a challenging trek through nature. The cool mountain air and impressive landscape make it a favorite for hikers and photography enthusiasts looking for hidden natural treasures.",
  },
  {
    id: 5,
    ...
    description:
      "Logending Beach features a wide coastal stretch with stunning sea views and natural cliff formations. With calm waves, it’s perfect for family visits, fishing, or simply watching the sunset. Traditional fishing boats add an authentic local charm to the beach’s serene atmosphere.",
  },
];
...
const TravelCard = () => {
  return (
    <div className="flex flex-col gap-6 px-4 py-6">
      {travelData.map(
        ({ id, title, price, rating, reviewers, location, description }) => (
          <div
            key={id}
                ...
                <div className="flex flex-col">
                  ...
                  <div className="my-2 text-sm font-semibold text-slate-600">
                    {price ? (
                      <Badge
                        variant="secondary"
                        className="bg-rose-100 text-rose-600 px-2 py-1 rounded-md"
                      >
